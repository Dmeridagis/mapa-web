...
var calles = L.geoJson(null, {
  style: function (feature) {
    switch (feature.properties.tipo) {
      ...
      case 'RP':
        return { color: '#E388FC', weight: 5, opacity: 0.9 };
      case 'RN':
        return { color: '#FC9A88', weight: 6, opacity: 0.9 };
      default:
...
var sitios = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.divIcon({
        className: 'fa', // La clase que usas para Font Awesome
        html: "<i class='fa-solid fa-landmark' style='font-size: 24px; color: gray;'></i>", // Aquí defines el ícono Font Awesome
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
var saludLayer = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.divIcon({
        className: 'fa', // La clase que usas para Font Awesome
        html: "<i class='fa-solid fa-hospital' style='font-size: 24px; color: red;'></i>", // Aquí defines el ícono Font Awesome
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
var seguridadLayer = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.divIcon({
        className: 'fa', // La clase que usas para Font Awesome
        html: "<i class='fa-solid fa-shield-halved' style='font-size: 24px; color: blue;'></i>", // Aquí defines el ícono Font Awesome
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
var deportesLayer = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.divIcon({
        className: 'fa', // La clase que usas para Font Awesome
        html: "<i class='fa-solid fa-futbol' style='font-size: 24px; color: green;'></i>", // Aquí defines el ícono Font Awesome
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
...
var groupedOverlays = {
  "Puntos de interes": {
    "<i class='fa-solid fa-landmark' style='font-size:20px; color:gray;'></i>&nbsp;Sitios": sitios,
    "<i class='fa-solid fa-hospital' style='font-size:18px; color:red;'></i>&nbsp;Salud": saludLayer,
    "<i class='fa-solid fa-shield-halved' style='font-size:20px; color:blue;'></i>&nbsp;Seguridad": seguridadLayer,
    "<i class='fa-solid fa-futbol' style='font-size:20px; color:green;'></i>&nbsp;Deportes": deportesLayer
